...
const getNews = async (locationData, category) => {
    try {
        let data = await promisifiedRequest ({url: `http://newsapi.org/v2/top-headlines?country=${locationData}&q=${category}from=${date}&sortBy=publishedAt&apiKey=2e777933b6094d929701f767de03fde4`, json: true})
